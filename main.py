    ...
    if skip_training == False:
        ...
        with tqdm(total=epochs * len(training_data), desc="Training loss") as t:
            for epoch in range(0, epochs):
                ...
                #   train
                loss_epoch = train(progress_bar_data, train_dataloader, model, device, loss_fn, optimizer)
...
class QuantLeNetD2L_DynBitWidth(nn.Module):
    ...
    def __init__(self):
        ...
        self.net = nn.Sequential(
            ...
            qnn.QuantReLU(weight_bit_width_impl_type='parameter',
                          bit_width=4,
                          return_quant_tensor=False),
...
def train(progress_bar_data, dataloader, model, device, loss_fn, optimizer):
    """
